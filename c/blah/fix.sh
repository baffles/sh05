...
proc_fix()
{
   ...
   if [ "$2" != "none" ]; then
      ...
      echo "# generated by fix.sh" > libacc\makefile
      echo "MAKEFILE_INC = $2" >> makefile
      echo "MAKEFILE_INC = $2" >> libacc\makefile
      echo "include makefile.all" >> makefile
      echo "include makefile.all" >> libacc\makefile
   fi

   echo "/* generated by fix.sh */" > include/platf.h
   echo "/* generated by fix.sh */" > libacc/include/platf.h
   echo "#define $3" >> include/platf.h
   echo "#define $3" >> libacc/include/platf.h
}
...
case "$1" in
   "bcc32"   ) proc_fix "Windows (BCC32)"   "makefile.bcc" "PLAT_BCC32";;
   "beos"    ) proc_fix "BeOS"              "makefile.be"  "PLAT_BEOS";;
   "djgpp"   ) proc_fix "DOS (djgpp)"       "makefile.dj"  "PLAT_DJGPP";;
   "mingw32" ) proc_fix "Windows (Mingw32)" "makefile.mgw" "PLAT_MINGW32";;
   "msvc"    ) proc_fix "Windows (MSVC)"    "makefile.vc"  "PLAT_MSVC";;
   "qnx"     ) proc_fix "QNX"               "makefile.qnx" "PLAT_QNX";;
   "unix"    ) proc_fix "Unix"              "none"         "PLAT_UNIX";;
   "mac"     ) proc_fix "Mac"               "none"         "PLAT_MPW";;
   "macosx"  ) proc_fix "MacOS X"           "makefile.osx" "PLAT_MACOSX";;
   "watcom"  ) proc_fix "DOS (Watcom)"      "makefile.wat" "PLAT_WATCOM";;
   "help"    ) proc_help;;
   *         ) proc_help;;
esac
